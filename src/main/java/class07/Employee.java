...
public  class Employee implements Comparable<class07.Employee> {
        private String id;
        private String name;
        ...
        public boolean equals(Object o) {
            ...
            class07.Employee employee = (class07.Employee) o;
        ...
        public boolean createPaycheck(LocalDate payday){
            return paychecks.add(new Paycheck(payday, salary));
        }
        ...
        @Override
        public int compareTo(class07.Employee other) {
