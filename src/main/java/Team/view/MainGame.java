import Team.modell.Player;
import Team.modell.Team;
import Team.modell.TeamDTO;
import Team.modell.persistence.SQLiteTeamDAO;
...
void main() {
       ...
       SQLiteTeamDAO repo = new SQLiteTeamDAO();

       TeamDTO dto = new TeamDTO(
               null,
               legendsTeam.getName(),
               legendsTeam.getBaseLocation(),
               legendsTeam.getCoachName()
       );

       SQLiteTeamDAO.createTable();

       repo.save(dto);

        System.out.println(repo.findOne("World Legends"));
